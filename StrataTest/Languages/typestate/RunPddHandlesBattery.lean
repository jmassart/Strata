...
/-! Battery runner for the PDD-handles typestate spec.
    `lake env lean --run StrataTest/Languages/typestate/RunPddHandlesBattery.lean` -/

open Strata Strata.Elab

def specsPath : String := "Examples/pdd-handles/handles.typestate.st"
def batteryDir : System.FilePath := "Examples/pdd-handles"
...
def main (_args : List String) : IO Unit := do
  ...
  IO.println s!"Running pdd-handles battery — {files.length} programs.\n"
